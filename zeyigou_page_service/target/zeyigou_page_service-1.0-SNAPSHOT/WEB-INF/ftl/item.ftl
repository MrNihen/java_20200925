...
<body ng-app="zeyigou" ng-controller="itemController" ng-init="loadSku()">
							...
							<#list customAttributeItems as attr>
								<#if attr??>
									<dl>
										...
										<dd><a href="javascript:;">${attr.value}</a></dd>
							...
							<#list specificationItems as spec>
								<dl>
									...
									<#list spec.attributeValue as value>
										<dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${value}') ? 'selected' : ''}}"
											   ng-click="selectSpec('${spec.attributeName}','${value}')">${value}</a></dd>
									</#list>
								</dl>
							</#list>
